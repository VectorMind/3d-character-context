...
| --- | --- | --- | --- | --- |
| [Donor Skeleton Extraction And Viewer](./2026-08/28-donor-skeleton-extraction/plan.md) | 2026-08-28 | Implementing | `▰▱▱▱▱▱ Phase 1/6` — extraction and viewer contracts settled; implementation next. | Extract and validate all donor skeletons/weights, add the browser overlay, then assess donor suitability for Riyu without canonical design. |
