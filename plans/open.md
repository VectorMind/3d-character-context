...
| --- | --- | --- | --- | --- |
| [Riyu Skeleton Fit And Rig Visualization](./2026-08/29-riyu-skeleton-fit/plan.md) | 2026-08-29 | Rough plan, stepwise | `▱▱▱▱▱▱▱ Step 0/7` — plan written; step 1 not started. | Fit european-dragon's hierarchy onto the generated Riyu mesh and see it, then landmarks, semantic naming, rig-influence visualization, and a distance heuristic scored against donor ground truth. Deliberately independent of the 2026-08-25 handoff's canonical-mesh-first route; per-character, no reusability yet. Review gate after step 3. |
